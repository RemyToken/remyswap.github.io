...
const REMY_TOKEN_ADDRESS = "HhJpBhRRn4g56VsyLuT8DL5Bv31HkXqsrahTTUCZeZg4";
...
const Form: React.FC<{
 ...
 function onClickSelectFromMint() {
    if (fromTokenInfo?.address !== REMY_TOKEN_ADDRESS) {
      setSelectPairSelector('fromMint');
    }
  }

  function onClickSelectToMint() {
    if (toTokenInfo?.address !== REMY_TOKEN_ADDRESS) {
    ...
    <div className="h-full flex flex-col items-center justify-center pb-4">
      <div className="w-full mt-2 rounded-xl flex flex-col px-2">
        <div className="flex-col">
                ...
                <div className={classNames('py-5 px-4 flex flex-col dark:text-white')}>
                  <div className="flex justify-between items-center">
                    ...
                    >
                      ...
                      {fromTokenInfo?.address !== REMY_TOKEN_ADDRESS &&
          ...
          <div className="border-b border-transparent bg-[#B47F8F] rounded-xl">
                ...
                <div className="py-5 px-4 flex flex-col dark:text-white">
                  <div className="flex justify-between items-center">
                    ...
                    >
                      ...
                      {toTokenInfo?.address !== REMY_TOKEN_ADDRESS &&
                        <span className="text-white/25 fill-current">
                          <ChevronDownIcon />
                        </span>
                      }
      ...
      <div className="w-full px-2">
        {!walletPublicKey ? (
          ...
          <JupButton
            size="lg"
            className="w-full mt-4 disabled:bg-[#C1C1C1] !bg-transparent"
            type="button"
            onClick={onSubmit}
