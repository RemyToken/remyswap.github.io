...
const SwitchPairButton = ({
  ...
  return (
    <div className="flex justify-center">
      <div
        onClick={onClick}
        className={`border fill-current text-black bg-[#B47F8F] dark:text-white-35 dark:hover:text-white/50 dark:border dark:border-white-35 dark:hover:border-white/50 h-8 w-8 rounded-full flex items-center justify-center cursor-pointer ${
